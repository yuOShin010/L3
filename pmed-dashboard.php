...
<head>
    ...
    <title>Dashboard - Accreditation</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Accredited <span>| Today</span></h5>
                            ...
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>3</h6>
                                            <span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">normal</span>
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Recent Accredited <span>| Today</span></h5>

                                    <table class="table table-borderless datatable">
                                        <thead>
                                            <tr>
                                                <th scope="col">id no. of Representative</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Rommel Constantino</td>
                                                <td>BSIT Department</td>
                                                <td><a href="#" class="text-primary">link of file sent</a></td>
                                                <td><span class="badge bg-success">10/22/2022</span></td>
                            ...
                            <div class="activity">
                                ...
                                <div class="activity-item d-flex">
                                    ...
                                    <div class="activity-content">
                                        BSIT submit <a href="#" class="fw-bold text-dark">Files</a> to you.
                                    </div>
                                </div>
                                <!-- End activity item-->
                                ...
                                <div class="activity-item d-flex">
                                    ...
                                    <div class="activity-content">
                                        You removed some files to accreditation
                                    </div>
                                </div>
                                <!-- End activity item-->
